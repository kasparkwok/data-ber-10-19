...
The dataset is downloaded from [Kaggle] https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data. 
Our aim is to analyse the database and determine the most important factors that have significant influence 

## 1. Analyse the columns
